#
#  Be sure to run `pod spec lint PublicTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "liujunzhang007"
  # s.authors            = { "liujunzhang007" => "liujunzhang007@sina.cn" }
  # s.social_media_url   = "http://twitter.com/liujunzhang007"
  ...
  s.source_files  = "PublicTools", "PublicTools/*.{h,m}"
