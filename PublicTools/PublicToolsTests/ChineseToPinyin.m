...
+ (NSString *)NSUTF_8ToGBKWithString:(NSString *)string{
    ...
    return [[string stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet controlCharacterSet]] stringByRemovingPercentEncoding];
}
+ (NSString *)GBKToNSUTF_8WithString:(NSString *)string;{
    
    return [string stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet controlCharacterSet]];
}
@end
